    ...
    <script type="text/javascript">
        var util = {
            ...
            file_upload: function file_upload() {
                ...
                // 使用ajax异步文件上传
                $.ajax({
                    url: util.basePath() + 'secure/upload-file',
                    type: 'POST',
                    data: obj,
                    contentType: false,
                    processData: false,
...
<form action="<%=basePath%>secure/upload-file" enctype="multipart/form-data" method="POST">
    <h2>基本form表单上传文件</h2>
    文件一：
...
<c:forEach items="${fileUrlList}" var="item">
    <img style="width:200px;height:200px" src="<%=basePath%>${item}">
</c:forEach>
</body>
</html>